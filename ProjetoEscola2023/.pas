...
void listarAlunosNome(Alunos Aluno[], int quant);
...
int MP(){
    ...
    printf("\n     3 - Alterar Alunos ");
    printf("\n     4 - Excluir Alunos  ");
    printf("\n  5- Listar aluno por sexo ");
   	printf("\n  6- Listar aluno por nome de Aluno \n");	
    scanf("%d",&op);
  return op;
}
...
void listarAlunos por nome(Alunos Aluno[], int quant) {
    printf("\n     LISTA DE ALUNOS  por nome  \n");
    int i, x, y, Aux;
    char aux[80]; 
        if (quant > 0) {
